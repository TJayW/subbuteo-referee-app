...
export const FOCUS_RING = 'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-0';

// Focus ring with offset (for buttons with borders)
export const FOCUS_RING_OFFSET = 'focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2';

// Focus-within variant (for containers)
export const FOCUS_RING_WITHIN = 'focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-0';

// Active zone indicator (controlled by state, not CSS focus)
export const ZONE_ACTIVE_RING = 'ring-2 ring-blue-500';
