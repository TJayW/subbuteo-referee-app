...
export const TeamsTab: React.FC<TeamsTabProps> = ({
  ...
  const TeamSection = ({
    ...
    <div className="ui-surface overflow-hidden">
      ...
      >
        <span className="font-semibold text-slate-900">{config.displayName || 'Squadra'}</span>
        <ChevronDown
          size={20}
        ...
        <div className="p-4 space-y-4 bg-white">
          ...
          <div className="border-t pt-4">
            <button
              ...
              className="w-full px-3 py-2 flex items-center justify-between bg-slate-50 hover:bg-slate-100 rounded-md transition"
            >
            ...
            {formationExpanded && (
              <div className="mt-3 space-y-3 bg-slate-50 p-3 rounded-md border border-slate-200">
                {/* Formation Presets */}
                <div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-2 py-1 text-xs bg-slate-900 text-white rounded hover:bg-slate-800 transition"
                    >
                      <Plus size={14} />
                      Aggiungi
                    </button>
                  ...
                  <div className="space-y-2 max-h-48 overflow-y-auto">
                    {config.formation.players.length === 0 ? (
                      ...
                      config.formation.players.map((player: Player, idx: number) => (
                        <div key={player.id} className="flex items-center gap-2 bg-white p-2 rounded border border-slate-200">
                          <input
                            type="number"
                            min="0"
                            max="99"
                            ...
                            className="w-10 px-2 py-1 border border-slate-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-sky-500"
                            placeholder="N"
                          />
                          ...
                          <input
                            ...
                            className="flex-1 px-2 py-1 border border-slate-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-sky-500"
                            placeholder="Nome"
                          />
                          ...
                          <select
                            ...
                            className="w-16 px-2 py-1 border border-slate-300 rounded text-xs focus:outline-none focus:ring-2 focus:ring-sky-500"
                          >
