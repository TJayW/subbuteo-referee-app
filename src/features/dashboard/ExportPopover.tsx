  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        className="p-2 text-white bg-gradient-to-br from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 hover:shadow-lg hover:shadow-sky-500/50 rounded-lg transition-all duration-200 active:scale-95 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 group"
      ...
      {isOpen && (
        ...
        >
          {/* Header */}
          <div className="px-4 py-4 border-b border-slate-100 bg-gradient-to-r from-slate-50 via-slate-50 to-sky-50">
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-sm text-slate-900 group-hover:text-sky-600 transition-colors duration-250">
                      {option.label}
                    </div>
          ...
          {/* Info Footer */}
          <div className="px-4 py-3 bg-sky-50/50 border-t border-sky-100 rounded-b-xl">
