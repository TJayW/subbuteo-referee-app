        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-black rounded-2xl overflow-hidden shadow-2xl border border-gray-800">
              <div className="aspect-video bg-black relative">
                {isConnecting ? (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-gradient-to-br from-sky-900/20 to-slate-900/40">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-gradient-to-br from-red-900/20 to-gray-900">
                    ...
                    <div className="text-center max-w-md">
                      ...
                      <button
                        onClick={handleRetry}
                        className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-sky-600 to-sky-500 hover:from-sky-700 hover:to-sky-600 text-white font-semibold rounded-lg transition-all shadow-lg shadow-sky-500/30 mx-auto"
                      >
              ...
              <div className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-xl p-6 border border-gray-800">
                ...
                <div className="flex items-center justify-center gap-8 py-4">
                  <div className="text-center flex-1 max-w-[200px]">
                    ...
                    <p className="text-sky-400 text-5xl font-bold">{metadata.score.home}</p>
                  </div>
                  ...
                  <div className="text-center flex-1 max-w-[200px]">
                    ...
                    <p className="text-sky-400 text-5xl font-bold">{metadata.score.away}</p>
                  </div>
                </div>
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div className="bg-gray-900/50 rounded-2xl border border-gray-800 overflow-hidden">
              {/* Chat Header */}
              <div className="bg-gradient-to-r from-sky-600 to-sky-700 p-4">
                  ...
                  <div className="h-[500px] overflow-y-auto p-4 space-y-4">
                    {messages.map((msg) => (
                      <div key={msg.id} className="flex gap-3 group">
                        <div className="w-8 h-8 bg-gradient-to-br from-sky-500 to-slate-700 rounded-full flex-shrink-0 flex items-center justify-center text-white text-sm font-bold">
                          {msg.user[0]}
                        </div>
                  ...
                  <div className="p-4 border-t border-gray-800">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-gray-800 text-white px-4 py-2 rounded-lg outline-none focus:ring-2 focus:ring-sky-500"
                      />
                      <button
                        onClick={handleSendMessage}
                        disabled={!chatMessage.trim()}
                        className="px-4 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-semibold"
                      >
                        Invia
                      </button>
                    </div>
