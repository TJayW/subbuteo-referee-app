...
import type { DomainMatchState, MatchPhase } from '@/domain/match/types';
...
interface MatchControlCardProps {
  ...
  onAddRecovery: (period: any, seconds: number) => void;
  onSetRecovery: (period: any, seconds: number) => void;
  onEndPeriod: () => void;
  onSkipHalftime: () => void;
...
export const MatchControlCard: React.FC<MatchControlCardProps> = ({
  ...
  }, [clearHold, onSuspend, suspensionReason]);
    ...
    <div className="ui-surface p-4 flex flex-col gap-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <ActionButton action="secondary" size="sm" onClick={onSkipHalftime}>
