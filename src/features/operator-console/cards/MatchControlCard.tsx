    ...
    <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-3 flex flex-col gap-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 border-t border-slate-200 pt-3">
          {dangerousButton('Terminate', onTerminateMatch, confirmTerminate, setConfirmTerminate, ShieldOff, 'bg-red-50 text-red-700')}
          {dangerousButton('Reset', onReset, confirmReset, setConfirmReset, RefreshCw, 'bg-slate-100 text-slate-700')}
        </div>
